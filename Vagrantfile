...
Vagrant.configure("2") do |config|
  ...
  # your network.
  config.vm.network "public_network", ip: "192.168.0.180", bridge: "en0: Wi-Fi (Wireless)"
  ...
  config.vm.disk :disk, size: "90GB", name: "extra"
  ...
  config.vm.provision "shell", path: "lvm2.sh"
